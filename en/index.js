function getFaviconHref() {
  ...
  function createProxy() {
    ...
    // Handler to detect state changes
    const handler = {
      set: function (target, property, value) {
        target[property] = value;
        // Additional actions after state change
    ...
    if (isIOS) {
      return `
        <div class="modal-content">
          ...
          <button id="ok-button">That's okay, I'll view it as a mobile website.</button>
        </div>
      `;
    }
    return `
      <div class="modal-content">
        ...
        <button id="wepp-install-button">Install</button>
        <button id="ok-button" style="margin-top: 20px">
          That's okay, I'll view it as a mobile website.
        </button>
      </div>
    `;
  };
